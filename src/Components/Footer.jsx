    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-center'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                ...
                <p className='text-gray-400 mt-4'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Upsum has been the industry's standard dummy text.</p>
            </div>
            ...
            <div className='w-full md:w-1/3'>
                ...
                <p className='text-gray-400 mb-4 max-2-80'>
                ...
                <div className='flex gap-2'>
                    ...
                    <button className='py-2 px-4 rounded bg-blue-500 text-white cursor-pointer hover:bg-blue-600 transition-colors'>
                        Subscribe
                    </button>
                </div>
            </div>
